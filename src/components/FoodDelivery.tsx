...
export default function FoodDelivery() {
  return (
    ...
    >
      ...
      <i className="ph-fill ph-storefront absolute -left-10 -top-10 text-[120px] md:text-[140px] text-orange-500/[0.02] rotate-[45deg] pointer-events-none"></i>
      ...
      <div className="relative z-10">
        <div className="flex items-center gap-3 md:gap-4 mb-5 text-left">
          ...
          <div>
            <h4 className="font-serif text-[19px] md:text-3xl font-semibold text-dark mb-0.5 leading-tight">Local Food Delivery</h4>
            <div className="flex items-center gap-1.5">
              <i className="ph-fill ph-storefront text-orange-600 text-[10px] md:text-sm"></i>
              <span className="text-[11px] md:text-sm font-medium text-text-muted leading-tight">Order from nearby restaurants</span>
            </div>
          </div>
        </div>
