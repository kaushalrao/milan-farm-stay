...
export default function HomeDelivery() {
  ...
  return (
    <motion.div
      ...
      className="bg-white rounded-2xl md:rounded-3xl p-4 md:p-6 shadow-sm flex flex-col border border-orange-100/50 relative overflow-hidden group hover:shadow-md transition-shadow cursor-pointer"
    ...
    >
      ...
      <div className="flex items-center gap-3.5 md:gap-4 relative z-10 text-left">
        ...
        <div className="flex flex-col flex-1 min-w-0">
          <h4 className="font-serif text-[17px] md:text-2xl font-semibold text-dark mb-0.5 md:mb-1 leading-tight truncate">Home Delivery</h4>
          <div className="flex items-center gap-1 md:gap-1.5">
            <i className="ph-fill ph-user text-orange-600 text-[12px] md:text-base"></i>
            <span className="text-[10px] md:text-sm font-bold md:font-medium text-text-muted uppercase tracking-wider md:normal-case md:tracking-normal truncate">Manjunath</span>
          </div>
        </div>
