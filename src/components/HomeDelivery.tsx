...
export default function HomeDelivery() {
  ...
  return (
    <motion.div
      ...
      className="bg-warm-white rounded-2xl md:rounded-3xl p-4 md:p-6 shadow-sm flex flex-col justify-between border border-orange-100/60 dark:border-orange-500/20 relative overflow-hidden group hover:shadow-md transition-shadow cursor-pointer h-full"
    ...
    >
      ...
      <div className="flex flex-row lg:flex-col items-center lg:items-start gap-3.5 md:gap-4 mb-0 lg:mb-4 relative z-10 text-left">
        <div className="w-12 h-12 md:w-16 md:h-16 bg-gradient-to-br from-orange-50 to-orange-100/50 dark:from-orange-500/20 dark:to-orange-500/10 text-orange-600 dark:text-orange-400 rounded-full md:rounded-2xl flex items-center justify-center text-[22px] md:text-3xl shadow-sm border border-orange-100/60 dark:border-orange-500/20 shrink-0">
        ...
        <div className="flex flex-col flex-1 min-w-0">
          ...
          <div className="flex items-center gap-1 md:gap-1.5">
            <i className="ph-fill ph-user text-orange-600 dark:text-orange-400 text-[12px] md:text-base"></i>
      ...
      <div className="lg:hidden">
        <AnimatePresence initial={false}>
          {isExpanded && (
            ...
            >
              <div className="bg-orange-50/40 dark:bg-orange-500/10 border border-orange-100/60 dark:border-orange-500/20 p-3.5 md:p-5 rounded-xl md:rounded-2xl mb-4 backdrop-blur-sm">
                <ul className="space-y-2.5 md:space-y-3">
                  <li className="flex justify-between items-center text-dark border-b border-orange-100/60 dark:border-orange-500/20 pb-2.5 md:pb-3">
                    <span className="flex items-center gap-2 md:gap-3 text-sm md:text-base font-medium"><i className="ph-fill ph-shopping-cart text-orange-600 dark:text-orange-400/70 text-lg md:text-xl"></i> {t("items")}</span>
                    <span className="text-[10px] md:text-xs bg-warm-white dark:bg-white/5 text-dark dark:text-white px-2 py-1 md:px-3 md:py-1.5 rounded-md shadow-sm font-semibold border border-border/50 tracking-wide">{t("foodGroceries")}</span>
                  </li>
                  <li className="flex justify-between items-center text-dark">
                    <span className="flex items-center gap-2 md:gap-3 text-sm md:text-base font-medium"><i className="ph-fill ph-motorcycle text-orange-600 dark:text-orange-400/70 text-lg md:text-xl"></i> {t("deliveryFee")}</span>
                    <span className="text-[10px] md:text-xs bg-warm-white dark:bg-white/5 text-text-muted dark:text-gray-300 px-2 py-1 md:px-3 md:py-1.5 rounded-md shadow-sm font-medium border border-border/50">{t("variesDistance")}</span>
                  </li>
                </ul>
              </div>
